...
window.Helper =
  ...
  is_mobile         : (do_refresh)->
    if do_refresh || Helper.static_is_mobile is null
      Helper.static_is_mobile    = !!(((a)->
    ...
    return Helper.static_is_mobile
  static_is_mobile  : null
